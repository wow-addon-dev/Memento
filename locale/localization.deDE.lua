...
L["options.event.encounter.victory.first.tooltip"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenshots, wenn ein Boss bereits besiegt wurde. Diese Option gilt für jede Schwierigkeit getrennt."
L["options.event.encounter.victory.party.tooltip"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenshots, wenn ein Dungeon-Boss besiegt wurde."
L["options.event.encounter.victory.raid.tooltip"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenshots, wenn ein Raid-Boss besiegt wurde."
L["options.event.encounter.victory.scenario.tooltip"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenshots, wenn ein Szenario- oder Tiefen-Boss besiegt wurde."
L["options.event.encounter.wipe.party.tooltip"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenshots, wenn bei einem Dungeon-Boss eine Niederlage stattgefunden hat."
L["options.event.encounter.wipe.raid.tooltip"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenshots, wenn bei einem Raid-Boss eine Niederlage stattgefunden hat."
L["options.event.encounter.wipe.scenario.tooltip"] = "Aktiviere oder deaktiviere die automatische Erstellung eines Screenshots, wenn bei einem Szenario- oder Tiefen-Boss eine Niederlage stattgefunden hat."
...
L["chat.event.mythic.new"] = "Screenshot erstellt - |cnGOLD_FONT_COLOR:Mythic+ Dungeon|r"
